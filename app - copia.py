...
st.set_page_config(
    page_title="Monitorización de Tráfico YOLOv8",
...
def main():
    st.title("🚗 Monitorización de Detección con YOLOv8n")
    # ELIMINADO: st.markdown("Selecciona una fuente de entrada (Imagen, Video o Webcam) para iniciar la detección de objetos.")
